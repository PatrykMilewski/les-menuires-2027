...
export type Week = 'late' | 'feb' | 'febLate' | 'march';
...
export const weeks = {
  ...
  febLate: {label: '20–27 lutego', start: '2027-02-20', end: '2027-02-27', ski: '21–26 lutego', outbound: '270220', inbound: '270227'},
  march: {label: '6–13 marca', start: '2027-03-06', end: '2027-03-13', ski: '7–12 marca', outbound: '270306', inbound: '270313'},
};
export const baseFares: Record<Week, number> = {late:585,feb:309,febLate:336,march:475};
...
export function flightCost(week:Week='late'):number {return baseFares[week]+501.44+suitcasePerPerson;}
